<div id="form-report-lost" class="modal fade" tabindex="-1" data-width="760" style="display: none;">
  <div class="modal-form-report modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        <form action="" id="form-report-lost-tab-1">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="form-group">
              ...
              <div class="btn-block clearfix">
                <input type="file" class="filestyle" data-buttonText="Sube una foto" data-input="false" data-iconName="glyphicon-plus" data-classButton="btn btn-primary">
              </div>
            </div>
            <div class="form-group">
        ...
        <form action="" id="form-report-lost-tab-2" class="hide">
          <div class="col-lg-6 col-md-6">
            <div class="form-group">
        ...
        <form action="" id="form-report-lost-tab-3" class="hide">
          <div class="col-lg-6 col-md-6">
            <div class="form-group">
          ...
          <div class="col-lg-12 col-md-12 center-block">
            <div class="form-group form-actions">
              <button type="button" data-dismiss="modal" aria-hidden="true" class="btn btn-primary btn-button btn-lg">Finalizar</button>
            </div>
          </div>
        </form>
      </div>
