  ...
  <div id="page-home" class="container-fluid">
      ...
      <div class="block-about-us clearfix">
        <div class="block-about-us-item col-lg-4 col-md-4 col-sm-4">
          <a href="#">
            ...
            <img src="images/about_us_item_1.png">
        ...
        <div class="block-about-us-item col-lg-4 col-md-4 col-sm-4">
          <a href="#">
            ...
            <img src="images/about_us_item_2.png">
            <span class="block-about-us-line"></span>
          </a>
        </div>
        <div class="block-about-us-item col-lg-4 col-md-4 col-sm-4">
          <a href="#">
            ...
            <img src="images/about_us_item_3.png">
            <span class="block-about-us-line"></span>
          </a>
        </div>
      </div>
    ...
    <div class="row">
      <div class="block-partners clearfix">
        <ul>
          <li><a href="#"><img src="images/partners/logo_startup_peru.png"></a></li>
          <li><a href="#"><img src="images/partners/logo_pucp.png"></a></li>
          <li><a href="#"><img src="images/partners/logo_universidad_delima.png"></a></li>
          <li><a href="#"><img src="images/partners/logo_wuf.png"></a></li>
          <li><a href="#"><img src="images/partners/logo_voz_animal.png"></a></li>
          <li><a href="#"><img src="images/partners/logo_sos_veterinaria.png"></a></li>
        </ul>
      </div>
    </div>

    <?php include_once('block-suscription.php'); ?>
