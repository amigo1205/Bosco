    ...
    <div class="row">
      <div class="block-buttons">
        <div class="col-md-12 col-lg-12 text-center">
          <a href="index.php?page=dog-lost" class="btn btn-default btn-lg">Perdidos</a>
          <a href="index.php?page=dog-founds" class="btn btn-primary btn-lg">Encontrados</a>
        </div>
      </div>
    </div>
...
<section id="content">
  <div class="container">
    ...
    <?php include_once('block-filters.php'); ?>
          ...
          <ul class="text-center">
            <li>
              <a data-toggle="modal" href="#dog-detail">
                <img src="images/gallery_item.png" />
...
<?php require_once('modal-dog-detail.php'); ?>